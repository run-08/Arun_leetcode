<h2><a href="https://leetcode.com/problems/distinct-subsequences-ii/description/?envType=problem-list-v2&envId=dynamic-programming">977. Distinct Subsequences II</a></h2><h3>Hard</h3><hr><p>Given a string s, return <em>the number of <strong>distinct non-empty subsequences</strong> of</em> <code>s</code>. Since the answer may be very large, return it <strong>modulo</strong> <code>10<sup>9</sup> + 7</code>.</p>
